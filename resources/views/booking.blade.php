            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header ">
                        <span class="text-primary align:center">
                        ...
                        <form  method="POST" action="/booking/form">
                            ...
                            <div class="form-group ">
                                ...
                                <select name="position" class="form-control" >
                                    ...
                                    <option>Non-Acadamic</option>
                                </select>
                            </div>
                            <div class="form-group ">
                                <label for="slot_no"> Choose the slot</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="choose the slot" aria-label="Recipient's username" aria-describedby="basic-addon2" id="slot_no_input" value="" name="slot_no" >
                                    <div class="input-group-append">
                                    <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#exampleModal">Click me </button>
                                        <!-- Modal -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="faculty" placeholder="Your faculty"  required>
                                <input type="hidden" class="form-control"  name="user_id" placeholder="Your faculty" value="{{ $ID }}" required>
                            </div>
                            <div class="form-group">
                                <label for="daytime">Date and StartTime:</label>
                                <input type="datetime-local" id="daytime" name="daytime" value="{{$dateTime}}"class="form-control" >
                            </div>
                            <div class="form-group">
    ...
    <script>
        jQuery(document).ready(function(){
            jQuery("body a").click(function(){
                ...
                jQuery("a.moto rect").css("fill", "#800000");
                jQuery("a.moto path").css("fill", "#800000");
                jQuery("a.car rect").css("fill", "#008000");
                jQuery("a.booked rect").css("fill", "#ff0000");
                jQuery("input#slot_no_input").attr('value',$ID);
                jQuery("a#"+$ID+" rect").css("fill", "#1305a5");
            });
            jQuery("body a#M27").click(function(){    
                jQuery("a.moto rect").css("fill", "#800000");
                jQuery("a.car rect").css("fill", "#008000");
                jQuery("a.booked rect").css("fill", "#ff0000");            
                jQuery("input#slot_no_input").attr('value',"M27");
                jQuery("a#M27 path").css("fill", "#1305a5");
            });
        });
    </script>
@endsection
